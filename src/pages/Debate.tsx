                ...
                .then(async (res) => {
                    ...
                    await axios
                        ...
                        .then((res) => {
                            ...
                            setPopularSummaryLikes((prev) =>
                                prev.concat(itemLikes)
                            )
                        })
                })
                .finally(() => {
                    ...
                    <div className='left-container mx-4! md:w-3/5!'>
                        <div className='searchbox-container'>
                            ...
                            <input
                                type='text'
                                placeholder={t(
                                    'page.debate.search.placeholder'
                                )}
                                className='searchbox'
                                value={search}
                        ...
                        <div className='content-container'>
                            <InfiniteScroll
                                ...
                                hasNoItemMessage={t(
                                    'page.debate.item.no-debate-item'
                                )}
                                refreshCondition={
                                    categories !==
                                    ...
                                    sortByIdx !==
                                        prevValueRef.current.sortByIdx ||
                        ...
                        <div className='right-container-content'>
                            {popularSummaries.map((summary, index) => (
                                <PopularSummaryCard
                                    key={'summary' + index}
                                    summary={summary}
                                    hasLiked={popularSummaryLikes.includes(
                                        summary.id
                                    )}

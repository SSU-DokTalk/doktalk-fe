...
function SummaryDetail() {
    ...
    const getPurchase = (summary_id: number) => {
        axios.get(`/api/purchase/S/${summary_id}`).then((res) => {
            ...
            axios
                .get(`/api/summary/${summary_id}/charged_content`)
                .then((res) => {

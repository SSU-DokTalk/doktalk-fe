...
function ProfileTabDetails({
    ...
    const [purchasedSummaryLikes, setPurchasedSummaryLikes] = useState<
        number[]
    >([])
                ...
                axios
                    ...
                    .then((res) => {
                        let {
                            items,
                            total,
                        }: { items: MyBookType[]; total: number } = res.data
                        setMyBooks(items)
                ...
                axios
                    ...
                    .then((res) => {
                        let {
                            items,
                            total,
                        }: { items: SummaryType[]; total: number } = res.data
                        ...
                        <div className='currently-reading-books-container'>
                            <div className='currently-reading-header'>
                                ...
                                <div className='show-more'>
                                    {t(
                                        'component.section.profile-tab-details.item.show-more'
                                    ) + ' >'}
                                </div>
                            </div>
                            {!hasLoadedMyBook ? (
                                ...
                                <div className='no-item'>
                                    ...
                                    <Link to='/search' className='go-to'>
                                        {t(
                                            'component.section.profile-tab-details.go-to.search'
                                        ) + ' >'}
                                    </Link>
                                </div>
                            ) : (
                            ...
                            {!hasLoadedPurchaseSummary ? (
                                ...
                                <div className='no-item'>
                                    ...
                                    <Link to='/summary' className='go-to'>
                                        {t(
                                            'component.section.profile-tab-details.go-to.summary'
                                        ) + ' >'}
                                    </Link>
                                </div>
                            ) : (
                                        ...
                                        .map((summary, index) => {
                                            return (
                                                <SummaryCard
                                                    ...
                                                    summary={summary}
                                                    hasLiked={purchasedSummaryLikes.includes(
                                                        summary.id
                                                    )}
                                                    setHasLiked={
                                                        setPurchasedSummaryLikes
                                                    }
                                                />
                                            )
                                        })}
                        ...
                        <div className='select-month-container'>
                            <div className='month-box'>
                                <div
                                    ...
                                    onClick={async () => {
                                        ...
                                        await setPaymentCurTime(
                                            new Date(
                                                paymentCurTime.setMonth(
                                                    paymentCurTime.getMonth() -
                                                        1
                                                )
                                            )
                                        )
                                ...
                                <div className='cur-month'>
                                    ...
                                    {t(
                                        'component.section.profile-tab-details.time.year'
                                    )}{' '}
                                    {t(
                                ...
                                <div className='total-payment'>
                                    {t(
                                        'component.section.profile-tab-details.item.currency'
                                    )}
                                    {payments
                                        .filter((payment) => {
                                            let time = new Date(

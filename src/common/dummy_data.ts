...
export const DUMMY_SUMMARIES: SummaryType[] = [
  {
    ...
    free_content: DUMMY_BOOKS[3].description ?? 'string',
  ...
  },
  {
    ...
    free_content: DUMMY_BOOKS[4].description ?? 'string',
    charged_content: 'string',
    price: 0,
    category: 0,
    files: [{ name: '', url: 'https://example.com/' }],
  ...
  },
  {
    ...
    free_content: DUMMY_BOOKS[5].description ?? 'string',
    charged_content: 'string',
    price: 0,
    category: 0,
    files: [{ name: '', url: 'https://example.com/' }],
  ...
  },
  {
    ...
    user_id: 5,
    isbn: 9788936434120,
    title: DUMMY_BOOKS[6].title,
    free_content: DUMMY_BOOKS[6].description ?? 'string',
    charged_content: 'string',
    price: 0,
    category: 0,
    files: [{ name: '', url: 'https://example.com/' }],
  ...
  },
  {
    ...
    user_id: 5,
    isbn: 9791193992128,
    title: DUMMY_BOOKS[7].title,
    free_content: DUMMY_BOOKS[7].description ?? 'string',
    charged_content: 'string',
    price: 0,
    category: 0,
    files: [{ name: '', url: 'https://example.com/' }],
  ...
  },
  {
    ...
    user_id: 5,
    isbn: 9791193992128,
    title: DUMMY_BOOKS[8].title,
    free_content: DUMMY_BOOKS[8].description ?? 'string',
    charged_content: 'string',
    price: 0,
    category: 0,
    files: [{ name: '', url: 'https://example.com/' }],
...
export const DUMMY_DEBATES: DebateType[] = [
  {
    ...
    title: DUMMY_BOOKS[0].title,
    price: 0,
    content: DUMMY_BOOKS[0].description ?? 'string',
    files: [{ name: '', url: 'https://example.com/' }],
    category: 0,
    limit: 2,
    likes_num: 0,
    ...
    user: {
      id: 0,
      profile:
        'https://lh3.googleusercontent.com/a/ACg8ocK_Fm0rl3lUlSum3EV6eMSggBF9PfJ96_rFFVI7h6ScLdwPOA=s96-c',
      name: 'doktalk',
      role: 'USER',
      is_deleted: false,
    },
  ...
  },
  {
    ...
    location: 'string',
    held_at: new Date('2025-01-08T15:35:29.002Z'),
    title: DUMMY_BOOKS[1].title,
    price: 0,
    content: DUMMY_BOOKS[1].description ?? 'string',
    files: [{ name: '', url: 'https://example.com/' }],
    category: 0,
    limit: 2,
    likes_num: 0,
  ...
  },
  {
    ...
    title: DUMMY_BOOKS[3].title,
    price: 0,
    content: DUMMY_BOOKS[3].description ?? 'string',
    category: 0,
    limit: 2,
    likes_num: 0,
    comments_num: 0,
  ...
  },
  {
    ...
    title: DUMMY_BOOKS[4].title,
    price: 0,
    content: DUMMY_BOOKS[4].description ?? 'string',
    files: [{ name: '', url: 'https://example.com/' }],
    category: 0,
    limit: 2,
    likes_num: 0,
  ...
  },
  {
    ...
    title: DUMMY_BOOKS[5].title,
    price: 0,
    content: DUMMY_BOOKS[5].description ?? 'string',
    files: [{ name: '', url: 'https://example.com/' }],
    category: 0,
    limit: 2,
    likes_num: 0,
